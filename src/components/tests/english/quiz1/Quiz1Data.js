export default [
        {
            questionText: 'She took the shears and ________.',
            answerOptions: [
                {answerText: 'ate them with a piece of toast', isCorrect: false},
                {answerText: 'cut herself a nice slice of cheese', isCorrect: false},
        ...
        },
        {
            ...
            answerOptions: [
                {answerText: 'catches fish', isCorrect: false},
                {answerText: 'lays carpets', isCorrect: false},
        ...
        },
        {
            ...
            answerOptions: [
                {answerText: 'dust', isCorrect: false},
                {answerText: 'gust', isCorrect: true},
        ...
        },
        {
            ...
            answerOptions: [
                {answerText: 'crunchy', isCorrect: true},
                {answerText: 'dairy', isCorrect: false},
        ...
        },
        {
            ...
            answerOptions: [
                {answerText: 'brought', isCorrect: true},
                {answerText: 'grew', isCorrect: false},
